pipeline 
{
    ...
    parameters 
       {
             string(name: 'stg_one', defaultValue: '13.233.110.190', description: 'Staging Server')
             string(name: 'prd_one', defaultValue: '13.127.55.251', description: 'Production Server')
        }
